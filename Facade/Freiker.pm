...
EOF
	...
	[[qw(FreikerList ClubFreikerList)] => [
	    ...
	    miles => 'One<br>Way<br>Miles',
	    current_miles => 'Total<br>Miles',
	    kilometers => 'One<br>Way<br>Kilometers',
	    current_kilometers => 'Total<br>Kilometers',
